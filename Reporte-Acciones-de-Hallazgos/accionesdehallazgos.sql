...
**/
        ...
        CASE WHEN FORMGH.SG09 = 1 THEN 'Gestión de Activos (ISO 55001)' ELSE '' END SISTEMA_GESTION_55001,
         ...
         CASE
            WHEN FORMGH.MACRO = 'PROCESOS TRANSVERSALES' THEN
            CASE
                  WHEN FORMGH.PROCESO = 'COMPRAS Y CONTRATOS' THEN 'GESTION TRANSVERSAL COMPRAS'
                  WHEN FORMGH.PROCESO = 'REGULACION ' THEN 'GESTION TRANSVERSAL REGULATORIA'
                  WHEN FORMGH.PROCESO = 'GESTION ENERGETICA' THEN 'GESTION TRANSVERSAL ENERGETICA'
                  WHEN FORMGH.PROCESO = 'SISTEMA DE GESTION' THEN 'GESTION INTEGRADA'
                  WHEN FORMGH.PROCESO = 'INVERSIONES Y PMO' THEN 'INVERSIONES Y PMO'
                  WHEN FORMGH.PROCESO = 'MEDIO AMBIENTE' THEN 'GESTION TRANSVERAL MEDIO AMBIENTE'
                  WHEN FORMGH.PROCESO = 'COMPRAS Y CONTRATOS' THEN 'GESTION TRANSVERSAL PROVEEDORES'
                  WHEN FORMGH.PROCESO = 'GESTION DE PERSONAS' THEN 'GESTION TRANSVERSAL PERSONAS'
                  WHEN FORMGH.PROCESO = 'TIC' THEN 'TIC'
                  WHEN FORMGH.PROCESO = 'CONTROL DE GESTION ' THEN 'CONTROL DE GESTION '
                  WHEN FORMGH.PROCESO = 'PREVENCION DE RIESGOS LABORALES' THEN 'GESTION TRANSVERSAL SALUD Y SEGURIDAD EN EL TRABAJO'
                  WHEN FORMGH.PROCESO = 'CONTINUIDAD DE NEGOCIO' THEN 'GESTION TRANSVERSAL CONTINUIDAD DE NEGOCIO'
                  WHEN FORMGH.PROCESO = 'LOGISTICA' THEN 'LOGISTICA'
                  WHEN FORMGH.PROCESO = 'COMUNICACIONES' THEN 'GESTION TRANSVERSAL COMUNICACIONES'
                  WHEN FORMGH.PROCESO = 'SERVICIOS GENERALES' THEN 'SERVICIOS GENERALES'
                  WHEN FORMGH.PROCESO = 'SEGURIDAD' THEN 'SEGURIDAD CORPORATIVA'
                  WHEN FORMGH.PROCESO = 'CUMPLIMIENTO DE REQUISITOS' THEN 'GESTION TRANSVERSAL ANTISOBORNO'
                  WHEN FORMGH.PROCESO = 'RIESGO' THEN 'GESTION TRANSVERSAL RIESGOS'
                  WHEN FORMGH.PROCESO = 'RIESGO TECNOLOGICO' THEN 'GESTION TRANSVERSAL SEGURIDAD DE LA INFORMACION'
                  ELSE 'SIN DEFINIR'
            END
            ELSE FORMGH.PROCESO
            ...
            WHEN FORMGH.MACRO = 'PROCESOS TRANSVERSALES' THEN
            CASE
                  WHEN FORMGH.SUBPROCESO = 'COMPRAS' THEN 'GESTION TRANSVERSAL COMPRAS'
                  WHEN FORMGH.SUBPROCESO = 'REGULACION ' THEN 'GESTION TRANSVERSAL REGULATORIA'
                  WHEN FORMGH.SUBPROCESO = 'GESTION ENERGETICA' THEN 'GESTION TRANSVERSAL ENERGETICA'
                  WHEN FORMGH.SUBPROCESO = 'SISTEMAS DE GESTION' THEN 'GESTION INTEGRADA'
                  WHEN FORMGH.SUBPROCESO = 'INVERSIONES Y PMO' THEN 'INVERSIONES Y PMO'
                  WHEN FORMGH.SUBPROCESO = 'MEDIO AMBIENTE' THEN 'GESTION TRANSVERAL MEDIO AMBIENTE'
                  WHEN FORMGH.SUBPROCESO = 'CONTRATOS' THEN 'GESTION TRANSVERSAL PROVEEDORES'
                  WHEN FORMGH.SUBPROCESO = 'GESTION DE PERSONAS' THEN 'GESTION TRANSVERSAL IGUALDAD DE GENERO'
                  WHEN FORMGH.SUBPROCESO = 'TIC' THEN 'TIC'
                  WHEN FORMGH.SUBPROCESO = 'CONTROL DE GESTION ' THEN 'CONTROL DE GESTION '
                  WHEN FORMGH.SUBPROCESO = 'PREVENCION DE RIESGOS LABORALES' THEN 'GESTION TRANSVERSAL SALUD Y SEGURIDAD EN EL TRABAJO'
                  WHEN FORMGH.SUBPROCESO = 'CONTNUIDAD DE NEGOCIO' THEN 'GESTION TRANSVERSAL CONTINUIDAD DE NEGOCIO'
                  WHEN FORMGH.SUBPROCESO = 'LOGISTICA' THEN 'LOGISTICA'
                  WHEN FORMGH.SUBPROCESO = 'COMUNICACIONES' THEN 'GESTION TRANSVERSAL COMUNICACIONES INTERNAS'
                  WHEN FORMGH.SUBPROCESO = 'SERVICIOS GENERALES' THEN 'SERVICIOS GENERALES'
                  WHEN FORMGH.SUBPROCESO = 'SEGURIDAD' THEN 'SEGURIDAD CORPORATIVA'
                  WHEN FORMGH.SUBPROCESO = 'CUMPLIMIENTO DE REQUISITOS' THEN 'GESTION TRANSVERSAL ANTISOBORNO'
                  WHEN FORMGH.SUBPROCESO = 'RIESGO' THEN 'GESTION TRANSVERSAL RIESGOS'
                  WHEN FORMGH.SUBPROCESO = 'RIESGO TECNOLOGICO' THEN 'GESTION TRANSVERSAL SEGURIDAD DE LA INFORMACION'
                  ELSE 'SIN DEFINIR'
            END
            ELSE FORMGH.SUBPROCESO
